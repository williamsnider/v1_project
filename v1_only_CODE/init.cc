...
void pushMergedNeuronInitGroup0ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, unsigned int* spkQuePtr, scalar* V, scalar* m, scalar* h, scalar* n, float* inSynInSyn0, float* inSynInSyn1, unsigned int numNeurons) {
    MergedNeuronInitGroup0 group = {spkCnt, spk, spkQuePtr, V, m, h, n, inSynInSyn0, inSynInSyn1, numNeurons, };
...
void pushMergedNeuronInitGroup1ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, unsigned int numNeurons) {
    MergedNeuronInitGroup1 group = {spkCnt, spk, numNeurons, };
...
__device__ unsigned int d_mergedNeuronInitGroupStartID1[] = {230976, };
__device__ unsigned int d_mergedSynapseConnectivityInitGroupStartID0[] = {231040, };
